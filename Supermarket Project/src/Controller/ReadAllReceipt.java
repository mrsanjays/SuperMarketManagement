...
public class ReadAllReceipt {
	private ArrayList<Receipt> receipts;
	public ReadAllReceipt(Database database) {
		// TODO Auto-generated constructor stub
		String select = "SELECT * FROM `receipts` ;";
		ArrayList<Integer> cashierIDs = new ArrayList<Integer>();
		...
		for(int i = 0 ; i < receipts.size();i++) {
			receipts.get(i).setCashier(new ReadEmployee(cashierIDs.get(i), database).getEmployee());
